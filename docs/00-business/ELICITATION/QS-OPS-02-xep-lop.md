...
target_output: ["BF-CLS-01 validate", "US-CLS01-01..03 validate"]
duration: "20 phút"
status: "Active"
...
> **BF:** BF-CLS-01 · **Screen:** `class_assignment`
...
|---|---------|------|--------------|---------|
| 1 | Ai là người xếp HV vào lớp? | Chọn nhiều | ☐ BM ☐ Giáo vụ ☐ Sale (đề xuất) ☐ Hệ thống tự gợi ý | BF-CLS-01 §2 |
...
| Câu | → File | Mục |
|-----|--------|-----|
| 1-3 | BF-CLS-01, US-CLS01-01 | Validate matching logic |
