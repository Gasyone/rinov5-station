...
- Đây là tài liệu định danh — mọi tài liệu khác chỉ tham chiếu mã (`PERSONA-XXX`, `STAKE-YYY`), không lặp lại nội dung.
- Khi viết US/SR, Persona phải là 1 trong 5 mã ở mục 2.1, hoặc tạo Persona mới có Approval Log.
- Khi nghi ngờ vi phạm Capability–Persona Decoupling, đối chiếu mục 5: nếu nhiều Persona cần cùng một năng lực → tạo 1 CAP, không tạo nhiều bản sao.

### ⛔ Hàng rào An toàn (Guardrails)
- **KHÔNG** thêm Persona dựa trên cảm nhận. Phải dẫn nguồn (phỏng vấn / quan sát / dữ liệu sản phẩm).
- **KHÔNG** đặt thông tin PII thật của bất kỳ ai vào file Persona — luôn dùng tên giả ("Anh Nam", "Chị Hương").
- **KHÔNG** sửa RACI mục 4 mà không thông báo cho các Stakeholder bị ảnh hưởng.
