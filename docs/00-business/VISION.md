...
## 10. Chỉ dẫn cho AI Agent & Lập trình viên

- Đây là bản **tối thiểu cho Pilot 4**. Nhiều mục để `⓪` chờ Owner.
- Khi đề xuất feature mới, phải truy ngược về OKR-01 hoặc OKR-02 hoặc đề xuất OKR-03+.

### ⛔ Hàng rào An toàn (Guardrails)
- **KHÔNG** dùng VISION này như tài liệu chính thức cho HĐQT — đây là bản dựng để pilot framework.
- **KHÔNG** thay đổi North Star Metric không có chữ ký Owner.
- **KHÔNG** thêm OKR mới mà không liên kết với pain point ở mục 3.
