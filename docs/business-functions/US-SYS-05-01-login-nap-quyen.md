...
domain: IAM/AuthN
status: core
tags: [iam, authn, login, phien-dang-nhap]
bf: BF-SYS-05
---
...
| Trạng thái login | Xử lý trạng thái đang tải, lỗi đăng nhập, hệ thống chưa cấu hình, tài khoản bị khóa và yêu cầu đổi mật khẩu nếu có. |
...
| Hiện/ẩn mật khẩu | Nút biểu tượng | Cho phép đổi trạng thái hiển thị mật khẩu. | Có nhãn trợ năng theo ngôn ngữ hiện tại. |
| Đăng nhập | Primary Button | Gửi thông tin đăng nhập vào luồng auth hiện có. | Khi submit thì chuyển loading/disabled. |
| Thông báo lỗi | Inline Alert | Hiển thị lỗi đăng nhập, hệ thống chưa cấu hình hoặc tài khoản bị khóa. | Nội dung lỗi phải theo ngôn ngữ hiện tại. |
...
- `US-SYS-04-01` đã có topic, nhóm quyền, scope và permission matrix active.
...
- `US-SYS-04-01` cung cấp topic, role, scope và permission matrix.
- `US-SYS-04-02` cung cấp user và role assignment.
- Màn hình đăng nhập hiện có.
- Hệ thống đa ngôn ngữ cung cấp nội dung cho màn đăng nhập.
- Bộ quản lý phiên đăng nhập, điều hướng và quyền truy cập lúc chạy.
- Bộ tính quyền menu/action được phép.
- Bộ nạp danh mục quyền.
- Dịch vụ đọc/chuẩn hóa dữ liệu người dùng và quyền.
