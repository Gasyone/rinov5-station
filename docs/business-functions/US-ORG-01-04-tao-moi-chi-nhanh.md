...
- Form tạo mới này chỉ dùng để khởi tạo bản ghi lần đầu. Việc cập nhật thông tin sẽ diễn ra ở màn hình Chi tiết (Detail Page).
- Thiết kế UI cần chia theo các Section (`<Panel>`) như "Thông tin chung", "Vị trí địa lý" để dễ nhìn, tránh 1 form dài dọc.

### ⛔ Hàng rào An toàn (Guardrails)
- **KHÔNG** gộp việc tạo Phòng học (`US-ORG-01-02`) vào trong bước này. Tạo Chi nhánh gốc trước, sau đó vào Chi tiết chi nhánh mới bắt đầu thêm các phòng học (Tách biệt Concerns).
