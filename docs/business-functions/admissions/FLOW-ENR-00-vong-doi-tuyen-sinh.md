...
graph TD
    ...
    E1:::ops -->|Thực thi trên iPad| E3_Test(Bài test LWR)
...
2.  **Kiểm tra đầu vào:** Tạo Booking Test (`BF-ENR-01`). Học sinh làm bài trên thiết bị (LWR) và/hoặc được Giáo viên phỏng vấn (Speaking). Hệ thống tổng hợp điểm.
