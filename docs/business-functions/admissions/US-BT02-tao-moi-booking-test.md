...
> [!IMPORTANT]
> **Hiện trạng triển khai ERP V1 (Bỏ Tạo mới):** Trong phiên bản hiện tại (V1), hệ thống ERP không cung cấp nút bấm "Tạo mới đặt lịch" hay giao diện biểu mẫu tạo lịch hẹn. Tất cả các ca đặt lịch thi đầu vào đều được khởi tạo từ hệ thống quản lý quan hệ khách hàng (CRM) và đẩy tự động sang ERP thông qua API tích hợp thời gian thực. Đặc tả dưới đây đóng vai trò tham chiếu cho sự tích hợp API từ CRM sang ERP.
...
9. **[RULE-FORM-09] Giới hạn trùng lịch đánh giá của Học sinh:** Chặn đặt lịch thi đầu vào mới cho một học sinh cụ thể nếu học sinh đó đang có một ca đánh giá ở trạng thái chưa kết thúc (không phải "Hoàn thành", "Không đạt", hay "Đã hủy").
10. **[RULE-FORM-10] Khóa cứng thời lượng 30 phút:** Ca phỏng vấn của giáo viên mặc định cố định thời lượng là 30 phút, không hiển thị dropdown thay đổi thời lượng nhằm đảm bảo nhất quán lịch dạy.
...
| Loại ca test | Nhãn văn bản tĩnh | Có | Loại ca | Hiển thị cố định "30 phút" (hoặc dropdown bị vô hiệu hóa), không cho phép nhân sự thay đổi để tránh lệch ca phỏng vấn. |
