...
export const MOCK_TRIAL_CLASSES: TrialClass[] = [
  {
    ...
    sessions: [
      ...
      { className: 'Cambridge Starter A1', classId: 'CLS-001', sessionName: 'Starter S2', sessionId: 'SESS-9902', trialDate: '2026-05-22 18:00' },
      { className: 'Cambridge Starter A1', classId: 'CLS-001', sessionName: 'Starter S3', sessionId: 'SESS-9903', trialDate: '2026-05-25 18:00' }
    ],
    creator: 'Lan Anh',
    owner: 'Ms. Sarah',
  ...
  },
  {
    ...
    familyPhone: '0909 111 222',
    attempt: 'Lần 2',
    school: 'Rino Linh Đàm',
