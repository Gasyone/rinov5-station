...
export const mockProducts: Product[] = [
  ...
  { id: "p3", name: "Khóa học Tiếng Nhật N5", code: "CRS-JP5", category: "course", price: 4000000, status: "active", branch: "Chi nhánh Hồ Chí Minh", description: "Khóa học tiếng Nhật trình độ N5", duration: "4 tháng", tags: ["japanese", "n5"], createdAt: "2024-09-01" },
  ...
  { id: "p8", name: "Combo IELTS A1+B1", code: "COMBO-IELTS01", category: "combo", price: 6000000, status: "active", branch: "Chi nhánh Hà Nội", description: "Combo 2 khóa IELTS A1 và B1 (tiết kiệm)", tags: ["ielts", "combo"], createdAt: "2024-10-01" },
  { id: "p9", name: "Khóa học Tiếng Hàn Sơ Cấp", code: "CRS-KR", category: "course", price: 3800000, status: "inactive", branch: "Chi nhánh Hồ Chí Minh", description: "Khóa học tiếng Hàn sơ cấp", duration: "4 tháng", tags: ["korean", "beginner"], createdAt: "2024-12-01" },
