...
export const mockTeachers: TeacherRecord[] = [
  ...
  { id: 't2', code: 'GV-002', name: 'Hoàng Thị Giáo Viên', email: 'gv2@rinoedu.com', phone: '0922222222', branch: 'RinoEdu Cầu Giấy', subjects: ['English', 'Japanese'], status: 'active', totalStudents: 65, totalClasses: 3, rating: 4.5, startDate: '2023-06-01' },
  { id: 't3', code: 'GV-003', name: 'Trần Thị Hương', email: 'gv3@rinoedu.com', phone: '0933333333', branch: 'RinoEdu Hà Đông', subjects: ['TOEIC'], status: 'active', totalStudents: 56, totalClasses: 2, rating: 4.7, startDate: '2024-02-10' },
  { id: 't4', code: 'GV-004', name: 'Lê Thị Nga', email: 'gv4@rinoedu.com', phone: '0944444444', branch: 'RinoEdu Thủ Đức', subjects: ['Movers', 'Flyers'], status: 'active', totalStudents: 34, totalClasses: 2, rating: 4.9, startDate: '2024-08-20' },
  ...
  { id: 't6', code: 'GV-006', name: 'Võ Minh Hùng', email: 'gv6@rinoedu.com', phone: '0966666666', branch: 'RinoEdu Cầu Giấy', subjects: ['IELTS'], status: 'on_leave', totalStudents: 36, totalClasses: 1, rating: 4.6, startDate: '2023-09-15' },
  ...
  { id: 't8', code: 'GV-008', name: 'Bùi Thanh Tùng', email: 'gv8@rinoedu.com', phone: '0988888888', branch: 'RinoEdu Hà Đông', subjects: ['TOEIC'], status: 'resigned', totalStudents: 0, totalClasses: 0, rating: 3.8, startDate: '2021-03-01', notes: 'Nghỉ việc tháng 3/2026' },
]
