...
export const mockClassSessions: ClassSession[] = [
  ...
  { id: 'ses-010', code: 'SES-010', classId: 'c-ielts-b1', className: 'IELTS Junior 1B', classCode: 'IELTS-1B', teacher: 'Thầy Hùng', date: '2026-05-05', startTime: '17:00', endTime: '18:30', dayOfWeek: 'Thứ 3', room: 'B201', branch: 'RinoEdu Nguyễn Tuân', topic: 'Grammar: Conditionals', attended: 8, total: 12, status: 'audited', hasConflict: false },
  { id: 'ses-011', code: 'SES-011', classId: 'c-ielts-b1', className: 'IELTS Junior 1B', classCode: 'IELTS-1B', teacher: 'Thầy Hùng', date: '2026-05-07', startTime: '17:00', endTime: '18:30', dayOfWeek: 'Thứ 5', room: 'B201', branch: 'RinoEdu Nguyễn Tuân', topic: 'Vocabulary: Academic', attended: 0, total: 12, status: 'scheduled', hasConflict: false },
  { id: 'ses-012', code: 'SES-012', classId: 'c-ielts-b1', className: 'IELTS Junior 1B', classCode: 'IELTS-1B', teacher: 'Thầy Hùng', date: '2026-05-12', startTime: '17:00', endTime: '18:30', dayOfWeek: 'Thứ 3', room: 'B201', branch: 'RinoEdu Nguyễn Tuân', topic: 'Listening: Section 1', attended: 0, total: 12, status: 'scheduled', hasConflict: false },

  { id: 'ses-020', code: 'SES-020', classId: 'c-toeic-a2', className: 'TOEIC Foundation 2A', classCode: 'TOEIC-2A', teacher: 'Cô Hương', date: '2026-05-06', startTime: '19:00', endTime: '21:00', dayOfWeek: 'Thứ 4', room: 'C301', branch: 'RinoEdu Nguyễn Tuân', topic: 'Part 5: Incomplete Sentences', attended: 18, total: 20, status: 'completed', hasConflict: false },
  { id: 'ses-021', code: 'SES-021', classId: 'c-toeic-a2', className: 'TOEIC Foundation 2A', classCode: 'TOEIC-2A', teacher: 'Cô Hương', date: '2026-05-09', startTime: '19:00', endTime: '21:00', dayOfWeek: 'Thứ 7', room: 'C301', branch: 'RinoEdu Nguyễn Tuân', topic: 'Part 6: Text Completion', attended: 0, total: 20, status: 'rescheduled', notes: 'Phòng C301 bảo trì - dời sang T3', hasConflict: false },
  { id: 'ses-022', code: 'SES-022', classId: 'c-toeic-a2', className: 'TOEIC Foundation 2A', classCode: 'TOEIC-2A', teacher: 'Cô Hương', date: '2026-05-12', startTime: '19:00', endTime: '21:00', dayOfWeek: 'Thứ 3', room: 'C302', branch: 'RinoEdu Nguyễn Tuân', topic: 'Part 7: Reading', attended: 0, total: 20, status: 'scheduled', hasConflict: false },

  { id: 'ses-030', code: 'SES-030', classId: 'c-movers-2b', className: 'Movers 2B', classCode: 'MOV-2B', teacher: 'Cô Nga', date: '2026-05-04', startTime: '16:00', endTime: '17:30', dayOfWeek: 'Thứ 2', room: 'D401', branch: 'RinoEdu Smart City', topic: 'Unit 5: Animals', attended: 9, total: 10, status: 'completed', hasConflict: false },
  { id: 'ses-031', code: 'SES-031', classId: 'c-movers-2b', className: 'Movers 2B', classCode: 'MOV-2B', teacher: 'Cô Nga', date: '2026-05-07', startTime: '16:00', endTime: '17:30', dayOfWeek: 'Thứ 5', room: 'D401', branch: 'RinoEdu Smart City', topic: 'Unit 6: Food & Drinks', attended: 0, total: 10, status: 'in_progress', hasConflict: false },
  { id: 'ses-032', code: 'SES-032', classId: 'c-movers-2b', className: 'Movers 2B', classCode: 'MOV-2B', teacher: 'Cô Nga', date: '2026-05-11', startTime: '16:00', endTime: '17:30', dayOfWeek: 'Thứ 2', room: 'D401', branch: 'RinoEdu Smart City', topic: 'Unit 7: Sports', attended: 0, total: 10, status: 'scheduled', hasConflict: false },
