...
export const mockAttendanceRecords: AttendanceRecord[] = [
  ...
  { id: 'att-003', sessionId: 'ses-010', sessionCode: 'SES-010', className: 'IELTS Junior 1B', branch: 'RinoEdu Cầu Giấy', teacher: 'Thầy Hùng', date: '2026-05-05', sessionTime: '17:00-18:30', topic: 'Grammar: Conditionals', totalStudents: 12, present: 8, absent: 3, late: 1, excused: 0, submittedBy: 'Thầy Hùng', submittedAt: '2026-05-05 18:40', status: 'pending_review', hasConflict: false },
  { id: 'att-004', sessionId: 'ses-020', sessionCode: 'SES-020', className: 'TOEIC Foundation 2A', branch: 'RinoEdu Hà Đông', teacher: 'Cô Hương', date: '2026-05-06', sessionTime: '19:00-21:00', topic: 'Part 5: Incomplete Sentences', totalStudents: 20, present: 18, absent: 1, late: 0, excused: 1, submittedBy: 'Cô Hương', submittedAt: '2026-05-06 21:15', status: 'approved', hasConflict: false },
  { id: 'att-005', sessionId: 'ses-030', sessionCode: 'SES-030', className: 'Movers 2B', branch: 'RinoEdu Thủ Đức', teacher: 'Cô Nga', date: '2026-05-04', sessionTime: '16:00-17:30', topic: 'Unit 5: Animals', totalStudents: 10, present: 9, absent: 0, late: 1, excused: 0, submittedBy: 'Cô Nga', submittedAt: '2026-05-04 17:40', status: 'pending_review', hasConflict: false },
  { id: 'att-006', sessionId: 'ses-031', sessionCode: 'SES-031', className: 'Movers 2B', branch: 'RinoEdu Thủ Đức', teacher: 'Cô Nga', date: '2026-05-07', sessionTime: '16:00-17:30', topic: 'Unit 6: Food & Drinks', totalStudents: 10, present: 0, absent: 0, late: 0, excused: 0, submittedBy: '', submittedAt: '', status: 'no_attendance', hasConflict: false },
  ...
  { id: 'att-008', sessionId: 'ses-011', sessionCode: 'SES-011', className: 'IELTS Junior 1B', branch: 'RinoEdu Cầu Giấy', teacher: 'Thầy Hùng', date: '2026-05-07', sessionTime: '17:00-18:30', topic: 'Vocabulary: Academic', totalStudents: 12, present: 0, absent: 0, late: 0, excused: 0, submittedBy: '', submittedAt: '', status: 'no_attendance', hasConflict: false },
]
