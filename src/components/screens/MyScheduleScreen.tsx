        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-semibold text-red-700 dark:text-red-400 flex items-center gap-1">
              ...
              <span className="inline-flex rounded bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800 px-1.5 py-0.5 text-xs font-bold uppercase">KHAI GIẢNG</span>
            </span>
          </div>
          <div className="flex items-center gap-1.5">
