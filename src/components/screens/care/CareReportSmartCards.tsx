...
export function CareReportSmartCards({
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 py-0.5 select-none">
      ...
      >
        ...
        <div className="text-xs font-medium text-amber-600 dark:text-amber-400 truncate leading-tight">
          Muộn: 1 buổi
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between gap-1 min-w-0">
          ...
          <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400 leading-none shrink-0">
