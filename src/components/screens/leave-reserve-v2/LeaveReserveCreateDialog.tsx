...
export function LeaveReserveCreateDialog({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      classCode: student.enrolledClasses?.[0]?.classCode || 'CLS-NEW-01',
      productPackage: student.packageName || 'Gói chuẩn',
      parentName: student.parentName ? `Phụ huynh: ${student.parentName}` : undefined,
