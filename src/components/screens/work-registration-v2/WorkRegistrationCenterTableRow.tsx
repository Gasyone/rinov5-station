...
export function WorkRegistrationCenterTableRow({
  ...
  return (
    ...
    >
      <TableCell className="sticky left-0 z-10 bg-card font-medium group-hover:bg-muted">{summary.branch}</TableCell>
      <TableCell>
        ...
        <TableCell key={day.date} className="p-0 text-center">
          <Button
            ...
            onClick={(event) => {
              ...
              onOpenBranchDay(summary.branch, day.date, day.label)
            }}
          >
