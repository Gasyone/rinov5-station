...
import type { StudentGlobalLogV2 } from './studentsV2Helpers'

interface StudentDetailGlobalLogsTabProps {
  logs: StudentGlobalLogV2[]
}

export function StudentDetailGlobalLogsTab({ logs }: StudentDetailGlobalLogsTabProps) {
  return (
