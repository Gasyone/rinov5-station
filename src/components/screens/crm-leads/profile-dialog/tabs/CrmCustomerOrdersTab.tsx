...
import type { CustomerProfileOrder } from '../crmCustomerProfileTypes'
import { formatCurrencyVnd } from '../crmCustomerProfileHelpers'

interface CrmCustomerOrdersTabProps {
  orders: CustomerProfileOrder[]
  onOpenCreateOrder?: () => void
  onViewOrderDetail?: (orderNo: string) => void
}

export function CrmCustomerOrdersTab({
  orders,
  onOpenCreateOrder,
  onViewOrderDetail,
}: CrmCustomerOrdersTabProps) {
    ...
    <div className="space-y-3.5">
      ...
      {orders.length === 0 ? (
        <EmptyState
          ...
          description="Khách hàng chưa phát sinh đơn hàng nào trên hệ thống."
          action={
            onOpenCreateOrder
              ? {
