...
import type { CustomerProfileDelivery } from '../crmCustomerProfileTypes'

interface CrmCustomerDeliveriesTabProps {
  deliveries: CustomerProfileDelivery[]
}

export function CrmCustomerDeliveriesTab({
  deliveries,
}: CrmCustomerDeliveriesTabProps) {
    ...
    <div className="space-y-3.5">
      ...
      {deliveries.length === 0 ? (
        <EmptyState
          ...
          description="Chưa có thông tin xuất kho hoặc vận đơn giao nhận tài liệu, học liệu cho học viên này."
        />
      ) : (
