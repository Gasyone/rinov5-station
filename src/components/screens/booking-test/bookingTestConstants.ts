...
export const VOCAB_LEVEL_OPTIONS = [
  ...
  { value: 'rich', label: 'Phong phú' },
]

export const GRAMMAR_ERROR_OPTIONS = [
  { key: 'missingS', label: 'Thiếu "s" sau danh từ số nhiều' },
  { key: 'verbTense', label: 'Lỗi thì động từ' },
  { key: 'subjectVerbAgreement', label: 'Lỗi chia động từ theo chủ ngữ' },
  { key: 'wrongStructure', label: 'Sử dụng sai cấu trúc' },
  { key: 'wrongWordOrder', label: 'Sai thứ tự từ' },
]

export const OPEN_QUESTION_OPTIONS = [
  { value: 'cannotAnswer', label: 'Không thể trả lời' },
  { value: 'needsSupport', label: 'Cần hỗ trợ' },
  { value: 'fluentExpanded', label: 'Trôi chảy, mở rộng tốt' },
]

export const PRONUNCIATION_ERROR_OPTIONS = [
  { key: 'noEndingSound', label: 'Không có âm cuối' },
  { key: 'wrongEndingSound', label: 'Sai âm cuối' },
  { key: 'wrongStress', label: 'Sai vị trí trọng âm' },
]
