...
const COLUMN_DEFS: Array<{ label: string; className: string; sticky?: boolean }> = [
  {
    label: 'Chương trình / lịch test',
    className: 'sticky left-12 z-30 w-72 min-w-72 max-w-72 overflow-hidden bg-background',
    sticky: true,
  },
  { label: 'Học viên', className: 'min-w-72' },
  { label: 'Điện thoại', className: 'min-w-40' },
  { label: 'Cơ sở', className: 'min-w-52' },
