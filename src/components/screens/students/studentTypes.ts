...
export const STUDENT_STATUS_CONFIG: Array<{ id: StudentStatusId; label: string; statusKey: string }> = [
  ...
  { id: 'inactive', label: 'Không hoạt động', statusKey: 'inactive' },
  { id: 'graduated', label: 'Đã tốt nghiệp', statusKey: 'graduated' },
  { id: 'transferred', label: 'Đã chuyển', statusKey: 'transferred' },
]
