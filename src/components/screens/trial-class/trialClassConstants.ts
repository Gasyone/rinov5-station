...
export const MOCK_CLASS_OPTIONS: MockClassOption[] = [
  ...
  { classId: 'CLS-001B', className: 'Cambridge Starter A2 (Buổi tối)', teacher: 'Mr. John', program: 'Cambridge Starter', schedule: 'T2/T4/T6 19:15', enrolledStudents: 9, maxStudents: 15, classType: 'Lớp chính thức' },
  { classId: 'CLS-001C', className: 'Cambridge Starter W1 (Cuối tuần)', teacher: 'Cô Thu Trang', program: 'Cambridge Starter', schedule: 'T7/CN 09:00', enrolledStudents: 11, maxStudents: 15, classType: 'Lớp Workshop' },
  ...
  { classId: 'CLS-003B', className: 'English Foundation B1', teacher: 'Thầy Hoàng', program: 'English Foundation', schedule: 'T2/T6 18:00', enrolledStudents: 7, maxStudents: 15, classType: 'Lớp chính thức' },
  ...
  { classId: 'CLS-004B', className: 'Math Thinking M2 (Nâng cao)', teacher: 'Cô Thanh Mai', program: 'Math Thinking', schedule: 'T3/T5 19:00', enrolledStudents: 6, maxStudents: 15, classType: 'Lớp chính thức' },
  ...
  { classId: 'CLS-012', className: 'Cambridge Movers M1', teacher: 'Ms. Sarah', program: 'Cambridge Movers', schedule: 'T3/T5 18:00', enrolledStudents: 11, maxStudents: 15, classType: 'Lớp chính thức' },
  { classId: 'CLS-012B', className: 'Cambridge Movers M2 (Cuối tuần)', teacher: 'Mr. David', program: 'Cambridge Movers', schedule: 'T7/CN 10:00', enrolledStudents: 7, maxStudents: 15, classType: 'Lớp chính thức' },
