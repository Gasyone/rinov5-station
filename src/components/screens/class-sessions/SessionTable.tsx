...
export function SessionTable({
  ...
  return (
    <div className="rounded-lg border border-border bg-card overflow-hidden">
      <Table containerClassName="min-w-full overflow-visible" className="min-w-[850px]">
        <TableHeader>
          <TableRow className="border-b bg-muted/50 hover:bg-muted/50">
            ...
            <TableHead className="sticky left-12 z-20 w-64 min-w-64 max-w-64 bg-muted/50">Topic</TableHead>
      ...
      <div className="border-t px-3 py-2">
        <span className="text-xs text-muted-foreground">
          {groups.reduce((n, g) => n + g.sessions.length, 0)} buổi
        </span>
      </div>
    </div>
  )
