...
import { countEmployeesByStatus } from './employeesHelpers'
...
interface EmployeesToolbarProps {
  ...
  onStatusChange: (status: EmployeeStatusFilter) => void
...
export function EmployeesToolbar({
  ...
  const tiles: StatusTile<EmployeeStatusFilter>[] = EMPLOYEE_STATUS_TABS.map((tab) => ({
    id: tab.id,
    label: tab.label,
    count: countEmployeesByStatus(employees, tab.id),
    status: tab.status,
